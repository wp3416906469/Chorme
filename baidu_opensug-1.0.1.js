!(function() {
  ...
  (e.object = e.object || {}),
    ...
    (e.dom = e.dom || {}),
    (e.dom.g = function(e) {
      return typeof e === 'string' || e instanceof String ? document.getElementById(e) : e && e.nodeName && (e.nodeType == 1 || e.nodeType == 9) ? e : null;
    }),
    (e.g = e.G = e.dom.g),
    ...
    (e.dom._styleFilter.filter = function(t, n, o) {
      for (var i, r = 0, a = e.dom._styleFilter; (i = a[r]); r++) {
        (i = i[o]) && (n = i(t, n));
      }
      return n;
    }),
    ...
    (e.dom.getStyle = function(t, n) {
      ...
      var a = t.currentStyle || (e.browser.ie ? t.style : getComputedStyle(t, null));
      return (i = typeof r === 'object' && r.get ? r.get(t, a) : a[r || n]), (r = o._styleFilter) && (i = r.filter(n, i, 'get')), i;
    }),
    ...
    (e.dom.getPosition = function(t) {
      ...
      var o = e.browser;
      t = e.dom.g(t);
      var i = o.isGecko > 0 && n.getBoxObjectFor && e.dom.getStyle(t, 'position') == 'absolute' && (t.style.top === '' || t.style.left === '');
      var r = { left: 0, top: 0 };
      var a = o.ie && !o.isStrict ? n.body : n.documentElement;
      if (t == a) {
        return r;
      }
      var l;
      ...
      if (t.getBoundingClientRect) {
        ...
        if (n.getBoxObjectFor && !i) {
          ...
          s = t;
          do {
            if (((r.left += s.offsetLeft), (r.top += s.offsetTop), o.isWebkit > 0 && e.dom.getStyle(s, 'position') == 'fixed')) {
              (r.left += n.body.scrollLeft), (r.top += n.body.scrollTop);
              break;
            }
            s = s.offsetParent;
          } while (s && s != t);
          for ((o.opera > 0 || (o.isWebkit > 0 && e.dom.getStyle(t, 'position') == 'absolute')) && (r.top -= n.body.offsetTop), s = t.offsetParent; s && s != n.body; ) {
            (r.left -= s.scrollLeft), (b.opera && s.tagName == 'TR') || (r.top -= s.scrollTop), (s = s.offsetParent);
          }
        }
      }
      return r;
    ...
    (e.event.on = function(t, n, o) {
      (n = n.replace(/^on/i, '')), typeof t === 'string' && (t = e.dom.g(t));
      var i = function(e) {
        o.call(t, e);
      };
      var r = e.event._listeners;
    ...
    (function() {
      ...
      var n = function(e) {
        ...
        (e.listen = function(n, o) {
          t[n] = t[n] || [];
          for (var i = 0; i < t[n].length && t[n][i] != o; ) {
            i++;
          }
          ...
          (e.call = function(n) {
            if (t[n]) {
              for (var o = 0; o < t[n].length; o++) {
                t[n][o].apply(this, Array.prototype.slice.call(arguments, 1));
              }
            }
            return e;
          });
    ...
    (e.ui.suggestion._Div = function(t, n, o, i, r) {
      function a(e, n) {
        if (_.style.display == 'none') {
          return void t.call('need_data', o.getValue());
        }
        var i = s()[0];
        if ((l(), e)) {
          if (i == 0) {
      ...
      function s() {
        if (y && _.style.display != 'none') {
          for (var e = 0; e < y.length; e++) {
            if (y[e].className == h + 'mo') {
              return [e, p[e], m[e]];
            }
          }
        }
      ...
      function c(e) {
        var n = p && typeof e === 'number' && typeof p[e] !== 'undefined' ? p[e] : e;
        t.call('pick_word', n);
      }
      function f() {
        return _.style.display == 'none' ? null : ((w.style.display = _.style.display = 'none'), void r.onhide());
      }
      function g(e) {
        var n = e;
        return function() {
      ...
      return (
        ...
        t.listen('data_ready', function(n, o) {
          ...
          for (var r = 0, a = o.length; r < a; r++) {
            typeof o[r].input !== 'undefined' ? ((p[r] = o[r].input), (m[r] = o[r].selection)) : (m[r] = p[r] = o[r]);
          }
          if (p.length != 0) {
            y = i(_, m, b);
    ...
    (e.ui.suggestion._Data = function(e, t) {
      ...
      return (
        ...
        e.listen('need_data', function(o) {
          typeof n[o] === 'undefined' ? t(o) : e.call('data_ready', o, n[o]);
        }),
        {}
      );
    }),
    ...
    (e.ui.suggestion._Suggestion = function(t, n) {
      ...
      (o.inputElement = t),
        ...
        (o._adjustPos = function(n) {
          ...
          var r = a.shade;
          var l = document;
          var s = l.compatMode == 'BackCompat' ? l.body : l.documentElement;
          var u = s.clientHeight;
          var d = s.clientWidth;
          if (i.style.display != 'none' || !n) {
            var c = e.dom.getPosition(t);
            var f = [c.top + t.offsetHeight - 1, c.left, t.parentNode ? t.parentNode.offsetWidth : t.offsetWidth];
            (f = typeof o.options.view === 'function' ? o.options.view(f) : f),
              (i.style.display = r.style.display = 'block'),
              (r.style.top = f[0] + 'px'),
              (r.style.left = f[1] + 'px'),
              (r.style.width = f[2] + 'px');
            var g = parseFloat(e.getStyle(i, 'marginTop')) || 0;
            var p = parseFloat(e.getStyle(i, 'marginLeft')) || 0;
            if (((i.style.top = f[0] - g + 'px'), (i.style.left = f[1] - p + 'px'), e.ie && document.compatMode == 'BackCompat')) {
              i.style.width = f[2] + 'px';
            } else {
              var m = parseFloat(e.getStyle(i, 'borderLeftWidth')) || 0;
              var v = parseFloat(e.getStyle(i, 'borderRightWidth')) || 0;
              var y = parseFloat(e.getStyle(i, 'marginRight')) || 0;
        ...
        (o._draw = function(e, t) {
          ...
          return (
            ...
            e.appendChild(c),
            o._adjustPos(),
            window.checkBaiduGlass(),
            n
          );
        });
      var i = e.suggestion._Central.extend(o);
      var r = (new e.ui.suggestion._Data(i, o.options.getData), new e.ui.suggestion._InputWatcher(i, t, a));
      var a = new e.ui.suggestion._Div(i, t, r, o._draw, o.options);
      return (
        i.listen('start', function() {
          setInterval(function() {
            var e = a.element;
            e.offsetWidth != 0 && t.offsetWidth != e.offsetWidth && o._adjustPos();
          }, 100),
...
var BaiduSuggestion = (function() {
  ...
  function t(e, t, a, d) {
    if (e) {
      if (((typeof e === 'string' || e instanceof String) && (e = baidu.G(e)), e.sugId || (e.sugId = new Date().getTime()), s['sug' + e.sugId])) {
        return !1;
      }
      if (t == null) {
        var t = [];
        ...
        var f = t.fontSize ? t.fontSize : '14px';
        var g = t.fontFamily ? t.fontFamily : 'verdana';
        var p = t.bgcolorHI ? t.bgcolorHI : '#36c';
        var m = t.fontColorHI ? t.fontColorHI : '#FFF';
        var v = t.borderColor ? t.borderColor : '#817f82';
      ...
      if (r(document.body, 'position') == 'relative' || r(document.body, 'position') == 'absolute') {
  ...
  function n(e) {
    for (var t = e; t != document.body && t.tagName != 'FORM'; ) {
      t = t.parentNode;
    }
  ...
  for (var d = document.body.getElementsByTagName('INPUT'), c = 0, f = d.length; c < f; c++) {
    var g = d[c];
    if (g && (g.type == 'text' || g.type == 'search') && (g.getAttribute('baiduSug') == 1 || g.getAttribute('baiduSug') == 2)) {
      g.sugId = c;
      var p = g.getAttribute('baiduSug') == 1;
      t(g, null, null, p);
    }
  }
