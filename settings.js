...
const Settings = {
  ...
  defaults: {
    ...
    `,
    searchBookmarkStatus: true,
    searchHistoryStatus: true,
    searchTabsStatus: true,
    presupposition: `
      json: json
      calc: calc
      date: date,time
    ...
    iframeMap: {
      ip: {
        type: 'iframe',
        id: 60,
        pluginId: 'CSDNPlugin-93629669-1611657336315-06054541',
        url: `https://www.ip.cn/`,
        logo: 'https://img-operation.csdnimg.cn/plugin/image/icon/1615859869863.png',
        name: 'IP查询',
        height: '400px',
        css: `
             .layui-nav, .page_nav, .com-service, .footer, span {
            ...
            `,
        updateTime: '2020-12-20 00:00:00',
        enable: true,
        canDelete: false,
        defaultEnable: true,
        placeholder: '查询中...',
        createUser: 'csdnsearch', // 创建用户
      },
    },
    webPagesMap: [
      {
        ...
        type: 'webPage',
        canDelete: false,
        pluginId: 'CSDNPlugin-webPages_65171464-1614596442198-44274593',
        ...
        content: {
          ...
          html:
            ...
            '### 开发者助手帮助文档\n' +
            '#### 特点：\n' +
            '\t1. 支持本地书签、tab页、历史记录、远程CSDN结果便捷搜索\n' +
            '\t2. 集成开发者常用工具，通过搜索框、新标签页快速访问。更多工具支持在线扩展\n' +
            '\t3. 新标签页集成开发者常用网址导航，方便快捷访问常用网址\n' +
            '\t4. 所有操作都支持快捷键，提升操作效率\n' +
            '#### 唤起快捷搜索框:\n' +
            '\t在页面按相应快捷键即可唤起搜索框，快捷键具体如下：\n' +
            '|  快捷键  |  搜索范围  |   是否新窗口打开  |\n' +
            '|  ----  |  ----  |  ----  |\n' +
            '|  `c`  `o`  `ctrl + o`  |  `书签` `历史记录` `标签页` `CSDN结果`  |  否  |\n' +
            '|  `shift + c` `shift + o`  |  `书签` `历史记录` `标签页` `CSDN结果`  |  是  |\n' +
            '|  `b`  |  `书签`  |  否  |\n' +
            '|  `shift + b`  |  `书签`  |  是  |\n' +
            '|  `t`  |  `标签页`  |  否  |\n' +
            '\t搜索框以下2点需要单独说明下：\n' +
            '\t1. chrome浏览器的管理、设置页面不能唤起搜索框，正常网页、新标签页可以唤起\n' +
            '\t2. 搜索框除了可以搜索，也是开发者工具的入口，可以直接打开开发者常用工具\n' +
            '#### 开发者常用工具：\n' +
            '\t插件集成开发者常用工具，并支持在2种场景快捷访问\n' +
            '\t1. 搜索框场景：唤出搜索框后，再输入触发词即可使用。比如按c打开搜索框，然后输入json即可访问json格式化工具\n' +
            '\t2. 新标签页场景：在新标签页添加小工具快捷访问入口。推荐的网址导航"系统分类"里面可以看到所有的工具，点击即可添加到新版本页\n' +
            '\t以下列表为常用的开发者工具\n' +
            '|  工具名称  |  触发词  |   备注  |\n' +
            '|  ----  |  ----  |  ----  |\n' +
            '| json格式化工具 |  `json`  | 自带，也会在访问返回值为json格式地址时自动触发  |\n' +
            '| 计算器 |  `calc` `直接输入表达式会自动触发`  | 自带，科学计算器可以在扩展商店下载  |\n' +
            '| 时间戳转换 |  `date` `time`  | 自带  |\n' +
            '| ip查询 |  `ip`  | 自带  |\n' +
            '| 翻译 |  `wd`  | 自带  |\n' +
            '| 二维码生成 |  `qr` `qrcode`  | 自带  |\n' +
            '| 常用开发文档查询(java、vue等几十种文档) |  `doc`  | 自带  |\n' +
            '| 文件diff比较工具 |  `diff`  | 需到在线扩展商店下载  |\n' +
            '| 记事本 |  `note`  | 需到在线扩展商店下载  |\n' +
            '| 正在表达式测试、字符串编解码、 字符串加解密等几十种工具|    | 需到在线扩展商店下载  |\n' +
            '#### 如有问题，请联系我们\n' +
            '![微信群](https://plugin.csdn.net/images/chrome-qrcode.png)\n' +
            '#### 更多详细内容请访问：\n' +
            '1. 官网 [https://plugin.csdn.net](https://plugin.csdn.net)\n' +
            '2. 社区 [https://bbs.csdn.net/forums/plugin](https://bbs.csdn.net/forums/plugin)\n' +
            '\t\n' +
            '</textarea>\n' +
            '  </body>\n' +
            '</html>',
      ...
      },
      {
        ...
        content: {
          ...
          js:
            "// you js\n\nvar current_site_url;\nvar keyword_object;\n\nfunction change_site(url){\n\tcurrent_site_url = url\n}\nfunction search(){\n\tvar keyword = $('#keyword').val()\n\tvar url = current_site_url.replace('%s', keyword)\n\tconsole.info('show:' + url)\n\t$('#iframe_area').attr('src', url)\n}\n$(document).ready(function(){\n\t\n\tvar target = $('#myTab')\n\tvar site_array = [\n\t\t{id: 'youdao', name: '有道', url: 'https://dict.youdao.com/w/%s'},\n\t\t{id: 'bing', name: '必应', url: 'https://cn.bing.com/dict/search?q=%s'},\n\t\t//{id: 'iciba', name: '金山词霸', url: 'http://www.iciba.com/word?w=%s'},\n\t\t//{id: 'baidu', name: '百度翻译', url: 'https://fanyi.baidu.com/#en/zh/%s'},\n\t\t{id: 'dict', name: '海词', url: 'http://dict.cn/%s'}\n\t]\n\t\n\t$.each(site_array, function(i, n){\n\t\n\t\tvar link = $('<a class=\"nav-link '+ (i === 0 ? 'active': '')+'\" id=\"home-tab\" data-bs-toggle=\"tab\" href=\"#home\" role=\"tab\" aria-controls=\"home\">' + n.name + \t\t\t\t\t\t'</a>')\n\t\tlink.click(function(){\n\t\t\tchange_site(n.url)\n\t\t\tsearch()\n\t\t})\n\t\tvar element = $('<li class=\"nav-item\" role=\"presentation\"></li>')\n\t\telement.append(link)\n\t\ttarget.append(element)\n\t})\n\t\n\t$('#myTab a').on('click', function (event) {\n\t\tevent.preventDefault()\n\t\t$(this).tab('show')\n\t})\n\t\n\tchange_site(site_array[0].url)\n\t\n\t$('#search-button').on('click', function (event) {\n\t\tsearch()\n\t})\n\tkeyword_object = $('#keyword')\n\tkeyword_object.keyup(function(event){\n\t\tif(event.keyCode ==13){\n\t\t\tsearch()\n\t\t}\n\t});\n\tsearch()\n\n})",
          html:
            '<!doctype html>\n<html lang="en">\n  <head>\n    <!-- Required meta tags -->\n    <meta charset="utf-8">\n    <meta name="viewport" content="width=device-width, initial-scale=1">\n\n    <!-- Bootstrap CSS -->\n    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous">\n\t\t    <script src="https://cdn.jsdelivr.net/npm/jquery@3.2.1/dist/jquery.min.js"></script>\n\n    <title>单词查询</title>\n  </head>\n  <body>\n\t\t<div class="container">\n\t\t\t<div class="row">\n\t\t\t\t<div class="col">\n\t\t\t\t\t<div class="input-group mb-3">\n\t\t\t\t\t\t<input id="keyword" type="text" class="form-control" placeholder="请输入单词" aria-label="Recipient\'s username" aria-describedby="button-addon2">\n\t\t\t\t\t\t<button class="btn btn-outline-secondary" type="button" id="search-button">查询</button>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class="row">\n\t\t\t\t<div class="col">\n\t\t\t\t\t<ul class="nav nav-tabs" id="myTab" role="tablist">\n\t\t\t\t\t</ul>\n\t\t\t\t\t<div class="tab-content" id="myTabContent">\n\t\t\t\t\t\t<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">\n\t\t\t\t\t\t\t<iframe src="" id="iframe_area" class="iframe_area"/>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t\t\n\n    \n\n    <!-- Optional JavaScript; choose one of the two! -->\n\n    <!-- Option 1: Bootstrap Bundle with Popper -->\n    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-ygbV9kiqUc6oa4msXn9868pTtWMgiQaeYH7/t7LECLbyPA2x65Kgf80OJFdroafW" crossorigin="anonymous"></script>\n\n    <!-- Option 2: Separate Popper and Bootstrap JS -->\n    <!--\n    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.5.4/dist/umd/popper.min.js" integrity="sha384-q2kxQ16AaE6UbzuKqyBE9/u/KzioAlnx2maXQHiDX9d4/zp8Ok3f+M7DPm+Ib6IU" crossorigin="anonymous"></script>\n    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/js/bootstrap.min.js" integrity="sha384-pQQkAEnwaBkjpqZ8RU1fF1AKtTcHJwFl3pblpTlHXybJjHpMYo79HY3hIi4NKxyj" crossorigin="anonymous"></script>\n    -->\n  </body>\n</html>',
        },
        pluginId: 'CSDNPlugin-webPages_97993279-1612252939492-67438709',
        version: 'master',
        description: '',
        enable: true,
        updateTime: '2020-12-20 00:00:00',
        logo: 'https://img-operation.csdnimg.cn/plugin/image/icon/1614675998596.png',
        url: 'chrome-extension://fhgccpmahnalbajdplgfldmmmielfodf/pages/dynamicPlugin.html?pluginId=CSDNPlugin-webPages_97993279-1612252939492-67438709',
      },
    ],
    // 是否自动格式化页面JSON
    jsonConfig: {
